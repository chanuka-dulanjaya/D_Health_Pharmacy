...
function BrandStockreqDashboard() {
            ...
            <div class="dashboard-wrapper">
                <div style={{ paddingTop: '3%', paddingLeft: '2%', width: '98%' }}>
                    ...
                    <center style={{ marginTop: '6%' }}>
                        <h2 className="text-uppercase text-black">Brand & request Management </h2>
                        <br/>
                    </center>
...
export default BrandStockreqDashboard;
...
function OrderReport() {
    ...
    useEffect(() => {
       axios.get("http://localhost:5000/payment/allOrderVehiclePayment")
    ...
    useEffect(() => {
       axios.get("http://localhost:5000/payment/allOrderADVERTISEMENT")
    ...
    useEffect(() => {
       axios.get("http://localhost:5000/payment/allOrderBooking")
